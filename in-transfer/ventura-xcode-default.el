...
(let ((class '((class color) (min-colors 89)))
      ...
      (func-alt          "#7ac8b6")
      (keyword           "#fc5fa3")
      (line-num-active   "#dddddd")
      (line-num-inactive "#747478")
      (numeric           "#9686f5")
      (string            "#fc6a5d")
      (success           "#4dbf57")
      (type              "#91d462")
      ...
      (mode-line-fg      "#fafafa")
      (mode-line-fg-alt  "#6c7986")
      (mode-line-bg      "#121212")
      (mode-line-bg-alt  "#1b1b1b"))
  ...
  (custom-theme-set-faces
   ...
   `(org-agenda-date                          ((,class (:foreground ,variable ,@(when vscode-dark-plus-scale-org-faces (list :height 1.1))))))
