...
(defcustom ventura-xcode-default-render-line-highlight 'default
...
(let ((class '((class color) (min-colors 89)))
      (aurometalsaurus   "#6c7986")
      (blue-jeans        "#53a5fb")
      (brilliant-rose    "#fc5fa3")
      (charleston-black  "#292727")
      (chinese-black     "#121212")
      (dark-silver       "#6e6e6e")
      (eerie-black       "#1b1b1b")
      (gainsboro         "#dddddd")
      (golden-yellow     "#ffc501")
      (green-apple       "#4dbf57")
      (lotion-white      "#fafafa")
      (luminous-red      "#e21515")
      (medium-purple     "#9686f5")
      (outer-space       "#494848")
      (pastel-red        "#fc6a5d")
      (pearl-aqua        "#7ac8b6")
      (philippine-silver "#b4b3b3")
      (pistachio         "#91d462")
      (raisin-black      "#232222")
      (sonic-gray        "#747478")
      ...
      (fg1               gainsboro)
      (fg-hl             dark-silver)
      (builtin           medium-purple)
      (comment           aurometalsaurus)
      (constant          medium-purple)
      (errort            luminous-red)
      (func              pistachio)
      (func-alt          pearl-aqua)
      (keyword           brilliant-rose)
      (line-num-active   gainsboro)
      (line-num-inactive sonic-gray)
      (numeric           medium-purple)
      (string            pastel-red)
      (success           green-apple)
      (type              pistachio)
      (type-alt          pearl-aqua)
      (variable          blue-jeans)
      (variable-alt      violet-crayola)
      (warning           golden-yellow)

      (header-line-fg    philippine-silver)
      (header-line-bg    charleston-black)
      (mode-line-fg      lotion-white)
      (mode-line-fg-alt  aurometalsaurus)
      (mode-line-bg      chinese-black)
      (mode-line-bg-alt  eerie-black))
  ...
  (custom-theme-set-faces
   ...
   `(region                                   ((,class (:background ,bg-hl :distant-foreground ,fg-hl :extend nil))))
   ...
   `(error                                    ((,class (:foreground ,errort))))
   `(warning                                  ((,class (:foreground ,warning))))
   `(success                                  ((,class (:foreground ,success))))
   `(dired-directory                          ((t (:inherit (font-lock-keyword-face)))))
   `(line-number                              ((,class (:inherit default :foreground ,line-num-inactive))))
   `(line-number-current-line                 ((,class (:inherit default :foreground ,line-num-active))))
   `(header-line                              ((,class (:foreground ,header-line-fg :background ,header-line-bg))))

   `(mode-line                                ((,class (:foreground ,mode-line-fg :background ,mode-line-bg))))
   `(mode-line-inactive                       ((,class (:foreground ,mode-line-fg-alt :background ,mode-line-bg-alt))))
   `(mode-line-buffer-id                      ((,class (:foreground ,white :background unspecified))))
   ...
   `(org-level-1                              ((,class (:bold nil :foreground ,pearl-aqua))))
   `(org-level-2                              ((,class (:bold nil :foreground ,pistachio))))
   `(org-level-3                              ((,class (:bold nil :foreground ,blue-jeans))))
   `(org-level-4                              ((,class (:bold nil :foreground ,golden-yellow))))
   `(org-level-5                              ((,class (:bold nil :foreground ,medium-purple))))
   `(org-level-6                              ((,class (:bold nil :foreground ,pastel-red))))
   `(org-level-7                              ((,class (:bold nil :foreground ,violet-crayola))))
   `(org-level-8                              ((,class (:bold nil :foreground ,luminous-red))))
   `(org-code                                 ((,class (:foreground ,pastel-red))))
   `(org-hide                                 ((,class (:foreground ,bg1))))
   `(org-date                                 ((,class (:underline t :foreground ,variable) )))
   `(org-footnote                             ((,class (:underline t :foreground ,lotion-white))))
   `(org-link                                 ((,class (:underline t :foreground ,type ))))
   `(org-special-keyword                      ((,class (:foreground ,apple-green))))
   `(org-block                                ((,class (:foreground ,philippine-silver :background ,eerie-black :extend t))))
   `(org-quote                                ((,class (:inherit org-block :slant italic))))
   `(org-verse                                ((,class (:inherit org-block :slant italic))))
   `(org-todo                                 ((,class (,@(when ventura-xcode-default-box-org-todo (list :box '(:line-width 1 :color ,brilliant-rose)))
                                                        :foreground ,brilliant-rose :bold nil))))
   `(org-done                                 ((,class (:box (:line-width 1 :color ,pistachio) :foreground ,pistachio :bold nil ))))
   `(org-warning                              ((,class (:underline t :foreground ,warning))))
   `(org-agenda-structure                     ((,class (:weight normal :foreground ,dark-silver :box (:color ,white) :background ,charleston-black))))
   `(org-agenda-date                          ((,class (:foreground ,variable ,@(when ventura-xcode-default-scale-org-faces (list :height 1.1))))))
   `(org-agenda-date-weekend                  ((,class (:weight normal :foreground ,white))))
   `(org-agenda-date-today                    ((,class (:weight normal :foreground ,keyword
                                                                ,@(when ventura-xcode-default-scale-org-faces (list :height 1.2))))))
   `(org-agenda-done                          ((,class (:foreground ,outer-space))))
   `(org-scheduled                            ((,class (:foreground ,type))))
   `(org-scheduled-today                      ((,class (:foreground ,func :weight normal
                                                                    ,@(when ventura-xcode-default-scale-org-faces (list :height 1.2))))))
   `(org-ellipsis                             ((,class (:foreground ,builtin))))
   `(org-verbatim                             ((,class (:foreground ,brilliant-rose))))
   `(org-document-title                       ((,class (:foreground ,type :bold t
                                                                    ,@(when ventura-xcode-default-scale-org-faces (list :height 1.2)))))) ; title
   `(org-document-info                        ((,class (:foreground ,golden-yellow)))) ; author, date etc.
   `(org-document-info-keyword                ((,class (:foreground ,apple-green))))  ; "#+Title", "#+Date" etc.
   ...
   `(term-color-yellow                        ((,class (:foreground ,ms-yellow :background ,variable))))
   `(term-color-magenta                       ((,class (:foreground ,ms-magenta :background ,builtin))))
   `(term-color-cyan                          ((,class (:foreground ,ms-bluegreen :background ,string))))
